...
def create_events_source_kafka(t_env):
    table_name = "green_events_hourly_tips"
    source_ddl = f"""
        CREATE TABLE {table_name} (
...
def run_hourly_tips_job():
    ...
    # Advance watermark after source goes idle so last open window fires
    ...
    try:
        ...
        print("Hourly tips job failed:", str(e))
